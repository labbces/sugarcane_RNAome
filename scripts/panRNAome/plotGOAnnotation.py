...
columns = ['panRNAome_category', 'gene_name', 'transcript_name', 'gene_function', 'transcript_length', 'transcript_function', 'Transcript Rfam family', 'Gene Rfam family', 'Transcript GO','Gene GO']
...
plt.title('Distribuição de Gene Ontology dos genes')
...
ax = sns.countplot(data=filtered_gene_df, x='gene_function', hue='Has Gene GO')
