...
# Desc: Transforma clusters de similaridade gerados pelo MMseqs2 em matriz de similaridade de grupos (analogo ao OrthoFinder)

# Modificar DB_clust.tsv (manter apenas nomes dos genotipos na segunda coluna dos clusters do MMseqs2)
