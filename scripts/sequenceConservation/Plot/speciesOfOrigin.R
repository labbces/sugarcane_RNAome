...
library(reshape2)
library(ggplot2)
setwd("C:/Users/Avell 5/OneDrive/Documents/Projects/Conferencias/Poster/2022/CBFV")
rm(list=ls())
...
fig
save_image(fig, file="speciesOfOriginSP80-3280.pdf",scale=6)
save_image(fig, file="speciesOfOriginSP80-3280.svg",scale=6)
