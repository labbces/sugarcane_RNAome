...
infile = "../fiberAndSugar/hoang/MCL/CNC/CV1.0/formated/out."
...
plt.text(3000, 0.23, '3000', va='top', ha='center', color='red')
...
xticks = [3000] # 2
for xtick in xticks:
    plt.plot([xtick, xtick], [0, 0.2], color='red', linestyle='dotted')   # 0.12 = CDF point for cluster size
