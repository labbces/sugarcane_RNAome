...
infile = "../fiberAndSugar/perlo/MCL/CNC/formated/out."
...
plt.text(2, 0.16, '2', va='top', ha='center', color='red')
...
plt.title('Cluster size distributions of Perlo2022 CNC network')
plt.grid(False)
