...
dds_vst$biomass_group <- sub(".*_(high|low)-biomass$", "\\1", dds_vst$Run)
...
# *** Saving PCA ***
#print(pca_plot) 
print("saving PCA as: plot_pca_vst_withBiomassGroups.png")
ggsave("plot_pca_vst_withBiomassGroups.png", pca_plot, bg = "white")
...
#print(pca_plot_se)
ggsave("plot_pca_SE_withoutBiomassGroups.png", pca_plot_se, bg = "white")