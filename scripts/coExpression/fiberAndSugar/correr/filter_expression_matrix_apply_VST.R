...
write.table(counts_matrix_vst_top20, file = "Correr2020_counts_filters_VST.txt", sep = "\t", quote = FALSE)

# *** 6 - Save CV for each gene (filtered + VST)
print("saving CV for each gene")
write.table(cv_after_cv_filter, file = "Correr2020_counts_filters_VST_CV.txt", sep = "\t", quote = FALSE)