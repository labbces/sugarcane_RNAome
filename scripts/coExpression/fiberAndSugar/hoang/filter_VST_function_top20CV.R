...
# write.table(vst_matrix_CNC_top, file = file.path(HOME_DIR, "Hoang2017_counts_filters_VST_CNC_CV_above2.txt"), sep = "\t", quote = FALSE)
# write.table(vst_matrix_coding_top, file = file.path(HOME_DIR, "Hoang2017_counts_filters_VST_coding_CV_above2.txt"), sep = "\t", quote = FALSE)
# write.table(vst_matrix_noncoding_top, file = file.path(HOME_DIR, "Hoang2017_counts_filters_VST_noncoding_CV_above2.txt"), sep = "\t", quote = FALSE)
